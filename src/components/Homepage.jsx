...
function Homepage() {
  return (
    <>
    <div className="bg-[url('C:\Users\Lenovo\OneDrive\Documents\GitHub\expo\src\assets\frontpage.jpg')] bg-no-repeat bg-cover">
    <Navbar fluid  className="bg-red-700">
      <NavbarBrand>
        <a href="https://www.ecellvnit.org/"><img src={Ecell} className="mr-3 h-6 sm:h-9"/></a>
    ...
    <div className=' h-screen'>
      ...
      <Button className="w-2/12 px-8 py-4 bg-gradient-to-r from-red-500 to-red-800 text-white font-bold rounded-full transition-transform transform-gpu hover:-translate-y-1 hover:shadow-lg ">Register</Button>
      <Button className="w-2/12 px-8 py-4 bg-gradient-to-r from-red-500 to-red-800 text-white font-bold rounded-full transition-transform transform-gpu hover:-translate-y-1 hover:shadow-lg ">Contact Us</Button>
      </div>
    </div>
    </div>  
    </>
