...
const AboutSection = () => {
  return (
    <>
      ...
      <div
        className="bg-auto text-white sm:bg-cover md:bg-cover lg:bg-cover xl:bg-cover ... bg-[url(https://media.istockphoto.com/id/1321467830/vector/red-abstract-background-abstract-luxury-red-background-valentine-layout-design-studio-room.jpg?s=612x612&w=0&k=20&c=HMi9eratTzZlDAvk-vLjpsa3TKSxjwTyWfeWLxGKoRQ=)] py-16 px-4"
        id="about"
      >
        <div className="mx-auto grid md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-xl">
              ...
              their cutting-edge innovations with the rest of the world at the
              event, which will also introduce them to a fantastic community
              that will support their progress. Startups that are interested
